...
const SubscribeInfo = ({ subscriber, subscribing }: SubscribeProps) => {
  ...
  return (
    <div className="flex items-center font-Cafe24SurroundAir text-wall-street dark:text-lazy-gray">
      <span className="cursor-pointer">
        <span className="cursor-pointer mr-1 font-Cafe24Surround text-footer-icon dark:text-white">
      ...
      <span className="cursor-pointer">
        <span className="mr-1 font-Cafe24Surround text-footer-icon dark:text-white">
